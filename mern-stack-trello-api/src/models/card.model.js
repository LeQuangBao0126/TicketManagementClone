...
import { CARD_MEMBERS_ACTION_PUSH, CARD_MEMBERS_ACTION_REMOVE } from '*/utilities/constants'
...
const cardCollectionSchema = Joi.object({
  ...
  //nhung member trong activeCard //comments trong 1 card
...
const pushNewComment = async (cardId, newComment) => {
  try {
    const result = await getDB().collection(cardCollectionName).findOneAndUpdate(
      { _id: ObjectId(cardId) },
